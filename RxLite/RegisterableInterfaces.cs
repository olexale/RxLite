...
namespace RxLite
{
    ...
    public interface ICreatesObservableForProperty
    {
        ...
        /// <returns>
        ///     A positive integer if GNFP is supported, zero or a negative
        ///     value otherwise
        /// </returns>
