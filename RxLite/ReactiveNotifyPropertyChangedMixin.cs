...
namespace RxLite
{
    ...
    {
        private static readonly IEnumerable<ICreatesObservableForProperty> ObservablesForProperty = new List
        ...
        private static IObservedChange<object, object> ObservedChangeFor(Expression expression,
        ...
        private static IObservable<IObservedChange<object, object>> NestedObservedChanges(Expression expression,
            IObservedChange<object, object> sourceChange, bool beforeChange)
        {
        ...
        private static ICreatesObservableForProperty NotifyFactoryCache(Type type, string propertyName,
            bool beforeChanged = false)
        {
            return ObservablesForProperty.Aggregate(Tuple.Create(0, (ICreatesObservableForProperty) null), (acc, x) =>
            {
        ...
        private static IObservable<IObservedChange<object, object>> NotifyForProperty(object sender,
            Expression expression, bool beforeChange)
        {
